...
public class App extends JFrame {
    ...
    public App() {
        ...
        encodeButton.setBounds(10, 280, 200, 30);
        ...
        keyField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void update() {
                if (!type.get()) {
                    ...
                    //vg.setkey(keyField.getText());
                    //System.out.println("PRINT " + vg.getClearChars(outField.getText(), keyField.getText()));
                    textField.setText(vg.getClearChars(outField.getText(), keyField.getText()));
                    System.out.println("TEXT " + vg.getClearChars(outField.getText(), keyField.getText()));
                    System.out.println("OUT: " + outField.getText() + " KEY " + keyField.getText());
                    //System.out.println(vg.getClearChars(outField.getText(), keyField.getText()));
                }
